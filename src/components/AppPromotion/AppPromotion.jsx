    ...
    return (
        <section className="app-promotion">
            ...
            <div className="app-promotion__image d-flex justify-content-center align-items-center gap-2">
                <img src={apple} onClick={() => window.open('https://www.apple.com/app-store/')} alt="App Store" className="app-promotion__store-logo" />
                <img src={google} onClick={() => window.open('https://play.google.com/store')} alt="Google Play Store" className="app-promotion__store-logo" />
            </div>
        </section>
    );
};
